  ...
  def create
    ...
    respond_to do |format|
      if @activity_type.save
        format.html { redirect_to(@activity_type, :notice => 'ActivityType was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @activity_type.update_attributes(params[:activity_type])
        format.html { redirect_to(@activity_type, :notice => 'ActivityType was successfully updated.') }
        format.xml  { head :ok }
      else
