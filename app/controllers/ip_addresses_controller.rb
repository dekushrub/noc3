class IpAddressesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ip_address.save
        format.html { redirect_to(@ip_address, :notice => 'IpAddress was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @ip_address.update_attributes(params[:ip_address])
        format.html { redirect_to(@ip_address, :notice => 'IpAddress was successfully updated.') }
        format.xml  { head :ok }
      else
