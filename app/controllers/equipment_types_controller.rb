  ...
  def create
    ...
    respond_to do |format|
      if @equipment_type.save
        format.html { redirect_to(@equipment_type, :notice => 'EquipmentType was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @equipment_type.update_attributes(params[:equipment_type])
        format.html { redirect_to(@equipment_type, :notice => 'EquipmentType was successfully updated.') }
        format.xml  { head :ok }
      else
